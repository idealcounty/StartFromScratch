    ...
    public ResponseEntity<?> endConversation() {
        ...
        public ResponseEntity<?> getGuide() {
            try {
                ...
                // 直接定义固定的引导话
                String guideReply = "你好！欢迎来到《Re0：从0开始的呢喃生活》！在这里，你将面对各种大学生活的场景和选择。你可以从给定的选项中选择，也可以自由发挥。每次选择都会影响你的学习、健康、游戏、社交和金钱属性。当这些属性达到特定值时，将会解锁不同的结局哦！随时点击“结束游戏”查看当前属性对应的结局吧！快来开启你的大学冒险之旅！输入“开始游戏”，来开启属于你的呢喃生活~";
